...
def print_playlist_stats():
    ...
    myXuid = "2541987111112175"
    for key, value in seasonDict.iteritems():
        response = get_arena_player_stats("myersyang", key)
        results = response['Results']
        result = results[0]
        lowerResult = result['Result']
        ...
        for playlist in arenaPlaylistStats:
            ...
            print 'INSERT INTO PLAYER_STATS (GamerXUID, PlaylistID, SeasonID, TotalGames, Wins, Loses, Rank, Tier)' 
            if csr is not None:
                print '    VALUES ({}, \'{}\', {}, {}, {}, {}, {}, {});'.format(myXuid, playDict[playlistID], value, playlist['TotalGamesCompleted'], playlist['TotalGamesWon'], playlist['TotalGamesLost'], csr['DesignationId'], csr['Tier'])
            else:
                print '    VALUES ({}, \'{}\', {}, {}, {}, {}, {}, {});'.format(myXuid, playDict[playlistID], value, playlist['TotalGamesCompleted'], playlist['TotalGamesWon'], playlist['TotalGamesLost'], 0, 0)
    return
